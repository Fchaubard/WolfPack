...
$(document).ready(function()
{
	...
	$(".signup_form").submit(function()
	{
		...
		$.post("ajax_signup.php",{ username_signup:$('#username_signup').val(),email:$('#email').val(),firstName:$('#firstName').val(),lastName:$('#lastName').val(),password_signup:$('#password_signup').val(),passwordconfirm:$('#passwordconfirm').val(),rand:Math.random() } ,function(data)
        {
    ...
    <label for="bar">First Name:</label>
