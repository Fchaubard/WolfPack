<script type="text/javascript">
	...
	if(typeof(EventSource)!=="undefined")
	{
	    ...
	    eSource.addEventListener('groupListFunction', function(event)
	    {
			//console.log(event.data);
			
			//write the received data to the page
			$(".groupList").html(event.data);
			//$(".groupName").collapsible("refresh");
	...
	{
	    $(".groupList").html("Whoops! Your browser doesn't receive server-sent events.");
	}
</script>