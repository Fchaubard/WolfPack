...
<div data-role="page">
	...
	$(document).bind('pageinit', function(){
		...
		$.post("./formatting/friend.php",{ "friendName":friendName,"option":friendUn,rand:Math.random() } ,function(data)
		{
		    ...
		    {
			$('.userListContainer').load('./formatting/userListReload.php', function(){$('ul').listview(); $('ul').listview('refresh').trigger('create'); $(".friendButton").button(); $(".friendButton").button('refresh');});
