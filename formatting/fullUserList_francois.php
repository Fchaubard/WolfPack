			...
			while($row = mysql_fetch_array($result)){
				...
				if($row["usericon"] == "")
					...
					?>
						 ...
						 echo "<form action=\"#\" method=\"post\" class=\"friend_form\" ><input type=\"hidden\" value=".$currentPerson." name=\"friendName\" id=\"friendName\"><input type=\"hidden\" value=\"uf\" name=\"option\" id=\"option\"><input type=\"submit\" value=\"Unfriend!\"/></form>";
						 }
						 else{
						 	//echo "Gets to Friend";
						 	echo "<form action=\"#\" method=\"post\" class=\"friend_form\"><input type=\"hidden\" value=".$currentPerson." name=\"friendName\"><input type=\"hidden\" value=\"f\" name=\"option\"><input type=\"submit\" value=\"Friend!\"/></form>";
						 }
						 ?></li>
					<?php
